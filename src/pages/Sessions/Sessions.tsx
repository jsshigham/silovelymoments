        ...
        <div className="section1SessionsContainer">
          ...
          <div className="sessionDiv">
            ...
            <ul className="sessionUl">
              ...
              <li>Travel not included (required for over 3 hours of travel)</li>
            </ul>
            <h6 className="sessionDivH6">Add on:</h6>
            <ul className="sessionUl">
          ...
          <div className="sessionDiv">
            ...
            <ul className="sessionUl">
              ...
              <li>Travel not included (required for over 1 hours of travel)</li>
            </ul>
            <h6 className="sessionDivH6">Add on:</h6>
            <ul className="sessionUl">
              <li>
              ...
              <li>Special Requests: champagne, flowers, a sign, etc.</li>
            </ul>
